...
public class Main {
    ...
    private static void exercise1() {
        ...
        ourNumberInt+=2;
        String ourNumberString_2 = String.valueOf(ourNumberInt);
        System.out.println(ourNumberString_2);//Write your code here
    }
    ...
    private static void exercise4() {
        ...
        String start2= String.valueOf(startInt);
        StringBuilder repeat= new StringBuilder();
        repeat.append(start2);
        repeat.append(start2);
        double startDouble=(Double.valueOf(String.valueOf(repeat)))/3.5;
        System.out.println(Math.floor(startDouble));// Write your code here
    }
}